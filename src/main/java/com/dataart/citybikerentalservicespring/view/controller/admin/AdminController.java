...
public class AdminController {
    ...
    public List<PriceIntervalTO> priceIntervalManagementData() {
        return priceIntervalService.getPriceIntervalTOs();
    }

    @RequestMapping(value = "/api/bike/{bikeId}", method = RequestMethod.GET)
    public EditBikeTO editBikeData(@PathVariable("bikeId") int bikeId) throws CbrsException {
        ...
        return new EditBikeTO(slotTO, stationTOs);
    }
    ...
    public PriceIntervalTO editPriceIntervalData(@PathVariable("priceIntervalId") int priceIntervalId) throws CbrsException {
        ...
        return new PriceIntervalTO(priceInterval);
    }

    @RequestMapping(value = "/api/addstation", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/api/addslot/{stationId}", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/api/deletestation/{stationId}", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/api/deletebike/{bikeId}", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/api/addbike", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/api/deletepriceinterval/{priceIntervalId}", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/api/addpriceinterval", method = RequestMethod.POST)
